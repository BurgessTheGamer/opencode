...
- **PR**: [#486](https://github.com/sst/opencode/pull/486)
...
- **Features**:
  ...
  - 2-character wide hit zone for easier interaction
- **Status**: Submitted and merged
...
### ✅ Aiken Language Server Support (Updated)
...
- **Features**:
  ...
  - Uses OpenCode's `bun x` pattern (no global installs)
  - Real-time diagnostics, code completion, and hover information
  - Enables intelligent Cardano smart contract development
- **Implementation**:
  ```typescript
  spawn(BunProc.which(), ["x", "@aiken-lang/aiken", "lsp"])
  ```
- **Status**: Original PR submitted, updated based on feedback from head dev
